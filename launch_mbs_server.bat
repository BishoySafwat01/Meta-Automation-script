...
::  Version: V5.0.0 (Pure Python Zero-Extension Edition)
...
title Meta Business Suite Multi-Tenant Runner - V5.0.0

color 0B
echo.
echo  =============================================================================
echo   META BUSINESS SUITE INBOX AUTOMATOR - WINDOWS SERVER LAUNCHER (V5.0.0)
echo  =============================================================================
