...
::  Version: V4.9.6 (Pure Python Zero-Extension Edition)
...
title Meta Business Suite Multi-Tenant Runner - V4.9.6

color 0B
echo.
echo  =============================================================================
echo   META BUSINESS SUITE INBOX AUTOMATOR - WINDOWS SERVER LAUNCHER (V4.9.6)
echo  =============================================================================
