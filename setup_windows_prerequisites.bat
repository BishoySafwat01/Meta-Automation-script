...
::  Version: V4.9.5 (Pure Python Zero-Extension Enterprise Deployment)
...
title Meta Business Suite Automator - Prerequisites Setup (V4.9.5)

color 0B
echo.
echo  =============================================================================
echo   META BUSINESS SUITE INBOX AUTOMATOR - PREREQUISITES AUTO-INSTALLER (V4.9.5)
echo  =============================================================================
